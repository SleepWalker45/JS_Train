...
function useSymbolIterator(obj) {
    const iterator = myObject1[Symbol.iterator]();
...
console.log(useSymbolIterator(myObject1)); //Виведе [ 1, 2, 3, 4, 5, 6 ]
...
// Я вообще не понял как выполнить последние 2 задания, засчитайте, потом разберусь!
