...
function printUppercase(array) {
    // console.log(array.toString().toUpperCase());
...
function findMinMax([firstElement, ...restElements]) {
    let minresult = firstElement;
    let maxresult = firstElement;
    ...
    console.log(`Min: ${minresult} Max: ${maxresult}`);
...
function replaceNumbers(arr) {
    ...
    for (const item of arr) {
        if (item > 10) {
            arr2.push("Greater than 10");
        } else if (item <= 10) {
            arr2.push("Less than or equal to 10");
        }
    }
