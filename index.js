...
ScienceBook.info = 'история книги';
console.log(ScienceBook.info)
...
const Media = {
    ...
    length: 0,
    play: function() {
        console.log(`Зараз відтворюється медіа у форматі ${this.format} з тривалістю ${this.length} секунд.${this.artist} виконуе ${this.title}`)
    }
}
